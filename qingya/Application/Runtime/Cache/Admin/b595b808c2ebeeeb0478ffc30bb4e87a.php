...
<![endif]-->
        ...
        <!-- jQueryUI -->
        <link href="/Public/admin/css/sprflat-theme/jquery.ui.all.css" rel="stylesheet" />
        <!-- Bootstrap stylesheets (included template modifications) -->
        <link href="/Public/admin/css/bootstrap.css" rel="stylesheet" />
        <!-- Plugins stylesheets (all plugin custom css) -->
        <link href="/Public/admin/css/plugins.css" rel="stylesheet" />
        <!-- Main stylesheets (template main css file) -->
        <link href="/Public/admin/css/main.css" rel="stylesheet" />
        <!-- Custom stylesheets ( Put your own changes here ) -->
        <link href="/Public/admin/css/custom.css" rel="stylesheet" />
        <!-- Fav and touch icons -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="/Public/admin/img/ico/apple-touch-icon-144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="/Public/admin/img/ico/apple-touch-icon-114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="/Public/admin/img/ico/apple-touch-icon-72-precomposed.png">
        <link rel="apple-touch-icon-precomposed" href="/Public/admin/img/ico/apple-touch-icon-57-precomposed.png">
        <link rel="icon" href="/Public/admin/img/ico/favicon.ico" type="image/png">
    ...
    <body>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu email" role="menu">
                                    ...
                                    <li class="mail-list clearfix">
                                        <a href="#">
                                            <img src="/Public/admin/img/avatars/128.jpg" class="mail-avatar pull-left" alt="avatar">
                                            <p class="name">
                                    ...
                                    <li class="mail-list clearfix">
                                        <a href="#">
                                            <img src="/Public/admin/img/avatars/129.jpg" class="mail-avatar pull-left" alt="avatar">
                                            <p class="name">
                                    ...
                                    <li class="mail-list clearfix">
                                        <a href="#">
                                            <img src="/Public/admin/img/avatars/130.jpg" class="mail-avatar pull-left" alt="avatar">
                                            <p class="name">
                                    ...
                                    <li class="mail-list clearfix">
                                        <a href="#">
                                            <img src="/Public/admin/img/avatars/131.jpg" class="mail-avatar pull-left" alt="avatar">
                                            <p class="name">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown">
                                <a href="#" data-toggle="dropdown">
                                    <img class="user-avatar" src="/Public/admin/img/avatars/48.jpg" alt="SuggeElson">SuggeElson</a>
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="charts.html">图表 <i class="st-chart"></i></a>
                    </li>
                    <li>
                        <a href="#"> 表格 <i class="im-paragraph-justify"></i></a>
                        <ul class="nav sub">
                    ...
                    <li><a href="#"> 表格<i class="im-table2"></i></a>
                        <ul class="nav sub">
                    ...
                    <li><a href="#"> 用户界面元素 <i class="st-lab"></i></a>
                        <ul class="nav sub">
                            <li><a href="notifications.html"><i class="fa-bell"></i> 通知</a>
                            </li>
                            <li><a href="panels.html"><i class="br-window"></i> 面板</a>
                            </li>
                            <li><a href="tiles.html"><i class="im-windows8"></i> 拼贴</a>
                            </li>
                            <li><a href="elements.html"><i class="st-cube"></i> 基础</a>
                            </li>
                            <li><a href="icons.html"><i class="im-stack"></i> 图标</a>
                            </li>
                            <li><a href="buttons.html"><i class="im-play2"></i>按钮</a>
                            </li>
                            <li><a href="calendar.html"><i class="im-calendar2"></i>日历</a>
                            </li>
                            <li><a href="grid.html"><i class="st-grid"></i>网格</a>
                            </li>
                            <li><a href="typo.html"><i class="im-font"></i> 字体</a>
                            </li>
                            <li><a href="list.html"><i class="fa-list"></i> 列表</a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="#"><i class="ec-mail"></i> 电子邮件应用程序</a>
                        <ul class="nav sub">
                            <li><a href="email-inbox.html"><i class="ec-archive"></i> 收件箱</a>
                            </li>
                            <li><a href="email-read.html"><i class="br-eye"></i> 读取你收到的邮件 </a>
                            </li>
                            <li><a href="email-write.html"><i class="ec-pencil2"></i> 写邮件</a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="file.html"><i class="en-upload"></i> 文件管理</a>
                    </li>
                    <li><a href="gallery.html"><i class="im-images"></i> 画廊</a>
                    </li>
                    <li><a href="widgets.html"><i class="st-diamond"></i> 小工具 </a>
                    </li>
                    <li><a href="#"><i class="ec-location"></i> 地图</a>
                        <ul class="nav sub">
                            <li><a href="maps-google.html"><i class="im-map2"></i>谷歌地图</a>
                            </li>
                            <li><a href="maps-vector.html"><i class="en-location2"></i> 矢量地图 </a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="#">分页 <i class="st-files"></i></a>
                        <ul class="nav sub">
                            ...
                            <li>
                                <a href="#"><i class="st-files"></i> 错误页面</a>
                                <ul class="nav sub">
                    ...
                    <div class="sidebar-panel-content fullwidth pt0">
                            ...
                            <ul class="chat-ui bsAccordion">
                                    ...
                                    <ul class="in">
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/49.jpg" alt="@chadengle">Chad Engle
                                        ...
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/54.jpg" alt="@alagoon">Anthony Lagoon</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/52.jpg" alt="@koridhandy">Kory Handy</a>
                                            <span class="status"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/50.jpg" alt="@divya">Divia Manyan</a>
                                            <span class="status"><i class="en-dot"></i></span>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="in">
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/51.jpg" alt="@kolage">Eric Hofman</a>
                                            <span class="status online"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/55.jpg" alt="@mikebeecham">Mike Beecham</a>
                                            <span class="status online"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/53.jpg" alt="@derekebradley">Darek Bradly</a>
                                            <span class="status online"><i class="en-dot"></i></span>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/56.jpg" alt="@laurengray">Lauren Grey</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/49.jpg" alt="@chadengle">Chad Engle</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/58.jpg" alt="@frankiefreesbie">Frankie Freesibie</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/57.jpg" alt="@joannefournier">Joane Fornier</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="/Public/admin/img/avatars/59.jpg" alt="@aiiaiiaii">Alia Alien</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <div class="chat-box">
                            ...
                            <ul class="chat-ui chat-messages">
                                <li class="chat-user">
                                    <p class="avatar">
                                        <img src="/Public/admin/img/avatars/49.jpg" alt="@chadengle">
                                    </p>
                                ...
                                <li class="chat-me">
                                    <p class="avatar">
                                        <img src="/Public/admin/img/avatars/48.jpg" alt="SuggeElson">
                                    </p>
                                            ...
                                            <div id="instagram-widget" class="carousel slide">
                                                ...
                                                <div class="carousel-inner">
                                                    <figure class="item active">
                                                        <img class="img-responsive" src="/Public/admin/img/instagram/instagram.jpg" alt="image">
                                                    </figure>
                                                    <figure class="item">
                                                        <img class="img-responsive" src="/Public/admin/img/instagram/instagram2.jpg" alt="image">
                                                    </figure>
                                                    <figure class="item">
                                                        <img class="img-responsive" src="/Public/admin/img/instagram/instagram3.jpg" alt="image">
                                                    </figure>
                                                </div>
                                            </div>
                                            <!-- End Carousel -->
                        ...
                        <div class="col-lg-6 col-md-6 sortable-layout">
                            ...
                            <div class="weather-widget panel panel-primary plain toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-body blue-bg text-center">
                                    ...
                                    <p class="weather-location"><strong>24&deg;C</strong> Madrid</p>
                                </div>
        ...
        <!-- Javascripts -->
        <!-- Load pace first -->
        <script src="/Public/admin/plugins/core/pace/pace.min.js"></script>
        <!-- Important javascript libs(put in all pages) -->
        <script src="http://code.jquery.com/jquery-2.1.1.min.js"></script>
        <script>
        window.jQuery || document.write('<script src="/Public/admin/js/libs/jquery-2.1.1.min.js">\x3C/script>')
        </script>
        <script src="http://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
        <script>
        window.jQuery || document.write('<script src="/Public/admin/js/libs/jquery-ui-1.10.4.min.js">\x3C/script>')
        </script>
        <!--[if lt IE 9]>
  <script type="text/javascript" src="/Public/admin/js/libs/excanvas.min.js"></script>
  <script type="text/javascript" src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
  <script type="text/javascript" src="/Public/admin/js/libs/respond.min.js"></script>
<![endif]-->
        <!-- Bootstrap plugins -->
        <script src="/Public/admin/js/bootstrap/bootstrap.js"></script>
        <!-- Core plugins ( not remove ever) -->
        <!-- Handle responsive view functions -->
        <script src="/Public/admin/js/jRespond.min.js"></script>
        <!-- Custom scroll for sidebars,tables and etc. -->
        <script src="/Public/admin/plugins/core/slimscroll/jquery.slimscroll.min.js"></script>
        <script src="/Public/admin/plugins/core/slimscroll/jquery.slimscroll.horizontal.min.js"></script>
        <!-- Resize text area in most pages -->
        <script src="/Public/admin/plugins/forms/autosize/jquery.autosize.js"></script>
        <!-- Proivde quick search for many widgets -->
        <script src="/Public/admin/plugins/core/quicksearch/jquery.quicksearch.js"></script>
        <!-- Bootbox confirm dialog for reset postion on panels -->
        <script src="/Public/admin/plugins/ui/bootbox/bootbox.js"></script>
        <!-- Other plugins ( load only nessesary plugins for every page) -->
        <script src="/Public/admin/plugins/charts/flot/jquery.flot.js"></script>
        <script src="/Public/admin/plugins/charts/flot/jquery.flot.pie.js"></script>
        <script src="/Public/admin/plugins/charts/flot/jquery.flot.resize.js"></script>
        <script src="/Public/admin/plugins/charts/flot/jquery.flot.time.js"></script>
        <script src="/Public/admin/plugins/charts/flot/jquery.flot.growraf.js"></script>
        <script src="/Public/admin/plugins/charts/flot/jquery.flot.categories.js"></script>
        <script src="/Public/admin/plugins/charts/flot/jquery.flot.stack.js"></script>
        <script src="/Public/admin/plugins/charts/flot/jquery.flot.tooltip.min.js"></script>
        <script src="/Public/admin/plugins/charts/flot/date.js"></script>
        <script src="/Public/admin/plugins/charts/sparklines/jquery.sparkline.js"></script>
        <script src="/Public/admin/plugins/charts/pie-chart/jquery.easy-pie-chart.js"></script>
        <script src="/Public/admin/plugins/forms/icheck/jquery.icheck.js"></script>
        <script src="/Public/admin/plugins/forms/tags/jquery.tagsinput.min.js"></script>
        <script src="/Public/admin/plugins/forms/tinymce/tinymce.min.js"></script>
        <script src="/Public/admin/plugins/misc/highlight/highlight.pack.js"></script>
        <script src="/Public/admin/plugins/misc/countTo/jquery.countTo.js"></script>
        <script src="/Public/admin/plugins/ui/weather/skyicons.js"></script>
        <script src="/Public/admin/plugins/ui/notify/jquery.gritter.js"></script>
        <script src="/Public/admin/plugins/ui/calendar/fullcalendar.js"></script>
        <script src="/Public/admin/js/jquery.sprFlat.js"></script>
